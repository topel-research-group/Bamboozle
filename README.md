...
|----------------------------------------------|----------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|
| (Sorted) BAM input                           | `bamboozle.py pipeline -f <ref> {-F <fwd> -R <rev> \| -b <bam>} [options]`                         | Run SNP calling pipeline                                                                                                                |
...
| Identify potential barcode regions           | `bamboozle.py barcode -f <ref> -b <bam1> <bam2> ... <bamN> -o <prefix> --ploidy <ploidy> [options]`| Output BED and TXT files of coordinates for potential barcoding regions in the specified BAM files                                      |
