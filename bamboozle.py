...
parser.add_argument("--median", action="store_true", help="Report regions whose coverage differs by +/- >50 percent of the contig median; single contig.")
parser.add_argument("--medianall", action="store_true", help="Report regions whose coverage differs by +/- >50 percent of the contig median; whole assembly.")
